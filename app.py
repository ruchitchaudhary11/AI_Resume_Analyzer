            ...
            if pdf is not None and groq_api_key != '':
                try:
                    with st.spinner('Processing...'):
                        ...
                        strength = resume_analyzer.groq_llm(groq_api_key=groq_api_key, chunks=pdf_chunks, analyze=strength_prompt)
            ...
            if pdf is not None and groq_api_key != '':
                try:
                    with st.spinner('Processing...'):
                        ...
                        weakness = resume_analyzer.groq_llm(groq_api_key=groq_api_key, chunks=pdf_chunks, analyze=weakness_prompt)
